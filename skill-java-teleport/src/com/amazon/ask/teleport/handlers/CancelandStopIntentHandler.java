...
/**
 * The CancelandStopIntentHandler class handles requests to stop the skill.
 */
...
public class CancelandStopIntentHandler implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
      ...
      Image image = getImage("https://s3-eu-west-1.amazonaws.com/tsinkplekkpang/bg/kelpie_background8-big.png");
      String title = "Teleport";


      String speechText = "Goodbye. Come back soon to hear an other story.";
      String writtenText = "<font size=\"7\">  Goodbye. Come back soon to hear an other story. </font>";
      String primaryText = writtenText;

      String secondaryText = "";
      Template template = getBodyTemplate6(title, primaryText, secondaryText, image);
